            ...
            <div className="homepage-page-first-div">
                <div className="homepage-page-first-first-div">
                    ...
                    <div className="homepage-header-description">
                        <p>
                        To cater all your culinary needs. 
                        This platform harnesses tha seamless and enjoyable food shopping experience. 
                        </p>

                    </div>
                    <div className="homepage-header-order-now">
                        <button className="homepage-order-now-btn">
                        <NavLink to='/products'><li>Order Now</li></NavLink></button>
                    </div>
                </div>
